...
import { FlagTriangleRight, Mail, Lock, LogIn } from 'lucide-react'
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        <Suspense fallback={
          <div className="bg-white rounded-3xl shadow-xl p-8 border border-brand-cream-dark flex items-center justify-center min-h-[400px]">
